                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot)
                    {
                        ...
                        if(snapshot.exists())
                        {
                            for(DataSnapshot productJson: snapshot.getChildren())
                            {
                                ...
                                if(product.getStatus().equals("available") && !(product.getPostedBy().getId().equals(FirebaseAuth.getInstance().getUid())))
                                {
                            ...
                            binding.productList.setAdapter(new ProductAdapter(requireContext(), products,"home"));
                        }
                    }
